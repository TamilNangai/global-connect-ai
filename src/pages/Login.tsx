...
//     return isSignUp ? "Sign up to access UniSpeak AI" : "Sign in to your admin panel";
//   };
...
//                   className="text-xs text-royal hover:text-royal/80 transition-colors"
//                 >
//                   Forgot password?
//                 </button>
//               </div>
...
const Login = ({ setIsAuthenticated }: LoginProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      if (!isForgotPassword) {
        setIsAuthenticated(true); // ✅ mark as signed in
